          ...
          <div className="flex items-center justify-between">
            {quantity === 0 ? (
              <Button
                ...
                className="w-full bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white font-semibold py-2 px-3 sm:px-4 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-md text-sm sm:text-base"
              ...
              <div className="flex items-center gap-2 sm:gap-3 w-full">
                <Button
                  ...
                  className="bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-full w-7 h-7 sm:w-8 sm:h-8 p-0 flex items-center justify-center transition-all duration-300 shadow-sm"
                >
                  <Minus className="w-3 h-3 sm:w-4 sm:h-4" />
                </Button>
                
                <span className="font-bold text-gray-900 min-w-[1.5rem] sm:min-w-[2rem] text-center text-sm sm:text-base">
                  {quantity}
                </span>
                
                <Button
                  onClick={handleIncreaseClick}
                  className={`rounded-full w-7 h-7 sm:w-8 sm:h-8 p-0 flex items-center justify-center transition-all duration-300 shadow-sm ${
                    isAtMaxQuantity
                ...
                <Button
                  ...
                  className="ml-auto bg-red-500 hover:bg-red-600 text-white text-xs sm:text-sm px-2 sm:px-3 py-1 sm:py-2 rounded-lg transition-all duration-300 shadow-sm"
                >
                  Remove
                </Button>
              </div>
