...
export default function MenuPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-amber-100">
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6">
          <div className="flex items-center justify-between h-12 lg:h-14">
            ...
            <div className="flex items-center space-x-1 sm:space-x-2 lg:space-x-3">
              <ChefHat className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-orange-600" />
              <h1 className="text-base sm:text-lg lg:text-xl font-bold text-gray-900">Sri Kanya Family Restaurants</h1>
            </div>
      ...
      {/* Main Content */}
      <main id="main-content" className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 py-3 sm:py-4 lg:py-6">
        {/* Hero Section */}
        <div className="text-center mb-4 sm:mb-6 lg:mb-8">
          <div className="flex items-center justify-center space-x-2 sm:space-x-3 lg:space-x-4 mb-2 sm:mb-3 lg:mb-4">
            <Crown className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-orange-600" />
            <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900">Our Menu</h2>
            <Sparkles className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-orange-600" />
          </div>
          <p className="text-gray-700 text-xs sm:text-sm lg:text-base max-w-4xl mx-auto leading-relaxed px-3 lg:px-6">
        ...
        {/* Menu Items Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-2.5 sm:gap-3 lg:gap-4" role="list" aria-label="Menu items">
        ...
        {(!menuWithImages[activeCategory] || menuWithImages[activeCategory].length === 0) && (
          <div className="text-center py-8 sm:py-12 lg:py-16">
            <div className="text-3xl sm:text-5xl lg:text-7xl mb-3 sm:mb-4">🍽️</div>
            <h3 className="font-playfair text-lg sm:text-xl lg:text-2xl font-semibold text-gray-800 mb-2 sm:mb-3">
              Coming Soon
            </h3>
